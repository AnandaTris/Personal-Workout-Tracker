export const WORKOUT_DAYS = [
  ...
  },
  {
    ...
    exercises: [
      { id: 'shoulder-press',           name: 'Shoulder Press',           sets: 2, repsTarget: '8',    type: 'compound' },
      { id: 'lateral-raise',            name: 'Lateral Raise',            sets: 3, repsTarget: '10–12', type: 'isolation' },
      { id: 'rear-delt-fly',            name: 'Rear Delt Fly',            sets: 2, repsTarget: '12',   type: 'isolation' },
      { id: 'hammer-curl',              name: 'Hammer Curl',              sets: 2, repsTarget: '8',    type: 'isolation' },
      { id: 'bayesian-curl',            name: 'Bayesian Curl',            sets: 2, repsTarget: '10',   type: 'isolation' },
      { id: 'overhead-tricep-extension',name: 'Overhead Tricep Extension',sets: 2, repsTarget: '8',    type: 'isolation' },
      { id: 'tricep-pushdown',          name: 'Tricep Pushdown',          sets: 2, repsTarget: '10',   type: 'isolation' },
    ],
  },
  {
    day: 'C',
    ...
    exercises: [
      ...
      { id: 'pec-dec-fly',              name: 'Pec Dec Fly',              sets: 2, repsTarget: '10',   type: 'isolation' },
      { id: 't-bar-row',                name: 'T-Bar Row',                sets: 2, repsTarget: '7',    type: 'compound' },
      { id: 'lateral-raise',            name: 'Lateral Raise',            sets: 2, repsTarget: '12',   type: 'isolation' },
    ],
  },
  {
    ...
    label: 'Lower',
    exercises: [
      { id: 'leg-press',                name: 'Leg Press',                sets: 3, repsTarget: '8',    type: 'compound' },
      { id: 'romanian-deadlift',        name: 'Romanian Deadlift',        sets: 2, repsTarget: '8',    type: 'compound' },
      { id: 'walking-lunges',           name: 'Walking Lunges',           sets: 2, repsTarget: '10 each', type: 'compound' },
      { id: 'standing-calf-raise',      name: 'Standing Calf Raise',      sets: 3, repsTarget: '10',   type: 'isolation' },
      { id: 'hanging-leg-raise',        name: 'Hanging Leg Raise',        sets: 2, repsTarget: '10',   type: 'isolation', optional: true },
    ],
  },
]
